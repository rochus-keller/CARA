...
#include <SpecView/PeakListGadget.h>
...
namespace Spec
{
	...
	class MonoScope2 : public Lexi::MainWindow
	{
		Q_OBJECT
	public:
		...
		MonoScope2(Root::Agent *, Spectrum*, Project* = 0, 
	...
	private:
		...
		FRIEND_ACTION_HANDLER( MonoScope2 );
		void updateCaption();
		void buildMenus();
		...
		Lexi::GlyphWidget* d_listWidget;
		Lexi::GlyphWidget* d_mainPane;
		QWidget* d_depthPane;
