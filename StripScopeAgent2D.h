...
namespace Spec
{
	...
	class StripScopeAgent2D : public Root::Agent
	{
	public:
		...
		StripScopeAgent2D(Root::Agent*,Project*,Spectrum*);
	protected:
	...
	private:
		...
		FRIEND_ACTION_HANDLER( StripScopeAgent2D );
		PpmPoint d_cursor;
