...
void AidaCentral::handleHelpAbout( Action& a )
{
	...
	str.sprintf( "<html><body><p>Release: <strong>%s</strong> Date: <strong>%s</strong> </p>"
		...
		"<h4>Terms of use:</h4>"
		"<p>CARA is freeware, i.e. it can be used for free by anyone. You are required "
		"to cite Rochus Keller's PhD <em>Optimizing the Process of Nuclear Magnetic " 
		"Resonance Spectrum Analysis and Computer Aided Resonance Assignment</em> "
